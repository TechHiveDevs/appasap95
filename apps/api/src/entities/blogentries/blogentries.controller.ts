...
/**
 * import { Blogentries } from "@prisma/client";
 * import { blogentriesUseCase1Service } from "./blogentries-services/blogentriesUseCase1.service";
 */

// ----------------------------------------------------------------

const entity = `blogentries`;
const path = `/blogentries`;
